...
The source code for this book is hosted in GitHub: [https://github.com/Ortus-Solutions/cfcouchbase-sdk-docs](https://github.com/Ortus-Solutions/cfcouchbase-sdk-docs). You can freely contribute to it and submit pull requests. The contents of this book is copyright by [Ortus Solutions, Corp](http://www.ortussolutions.com) and cannot be altered or reproduced without author's consent. All content is provided _"As-Is"_ and can be freely distributed.
...
We highly encourage contribution to this book and our open source software. The source code for this book can be found in our [GitHub repository](https://github.com/Ortus-Solutions/cfcouchbase-sdk-docs) where you can submit pull requests.
